...
| Platform | File | Notes |
| --- | --- | --- |
| Windows | `F1nancer-<version>-setup.exe` | Requires [Microsoft Edge WebView2 Runtime](https://developer.microsoft.com/microsoft-edge/webview2/) (preinstalled on most Windows 10/11 systems). |
| macOS | `F1nancer-<version>.dmg` | Open the DMG and drag F1nancer to Applications. |
